...
public class ChatboxGenerator : MonoBehaviour
{
    ...
    public void 產生對話框()
    {
        Instantiate(ChatboxModule, Vector3.zero, Quaternion.identity, Parent); // ArgumentException: Cannot instantiate a ScriptableObject with a position and rotation
